...
in `rspack.config.mjs`(only support mjs format config file)

set jsx importsource and add plugin.
...
add `/// <reference types="@webspatial/rspack-plugin" />` to `react-env.d.ts`
